...
# Revenue growth
data = data[(data["Rev. Growth 5Y"] > 0.03) | (pd.isna(data["Rev. Growth 5Y"]))]
data = data[(data["Rev. Growth 3Y"] > 0.03) | (pd.isna(data["Rev. Growth 3Y"]))]
data = data[(data["Rev. Growth"] > 0.03) | (pd.isna(data["Rev. Growth"]))]

data = data[(data["Rev Gr. Next 5Y"] > 0.03) | (pd.isna(data["Rev. Growth 5Y"]))]
data = data[(data["Rev Gr. Next Y"] > 0.03) | (pd.isna(data["Rev. Growth"]))]

data = data[(data["OpInc Growth 5Y"] > 0.03) | (pd.isna(data["OpInc Growth 5Y"]))]
data = data[(data["OpInc Growth 3Y"] > 0.03) | (pd.isna(data["OpInc Growth 3Y"]))]
# data = data[data["OpInc Growth"] > 0.03]
...
data = data[(data["ROIC"] > 0.03) | (pd.isna(data["ROIC"]))]
data = data[(data["ROIC (5Y)"] > 0.03) | (pd.isna(data["ROIC (5Y)"]))]
