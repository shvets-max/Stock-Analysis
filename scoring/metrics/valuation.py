...
from constants import ALLOWED_GROUPS, Q_HIGH, Q_LOW, MIN_GROUP
...
COLS = list(VALUATION_WEIGHTS.keys())
LOWER_PREFERRED = COLS.copy()

geninfo = GeneralInfo()
geninfo.load_csv()


class Valuation(MetricBuilder):
    def __init__(self):
        self.__data = None
    ...
    def initialize_weights(self):
        self.weights = pd.DataFrame(
            data={k: [v] * self.data.shape[0] for k, v in VALUATION_WEIGHTS.items()},
