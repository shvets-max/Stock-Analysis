...
async def load_and_normalize_percentages_from_file(
    file: UploadFile = File(...),
) -> pd.DataFrame:
    """
    Loads a CSV file from UploadFile into a Pandas DataFrame,
    normalizes specified percentage columns, and returns the DataFrame.
